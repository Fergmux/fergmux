...
import githubBlack from '@/assets/icons/github.svg'
import githubWhite from '@/assets/icons/github-dark.svg'

export default {
  setup() {
    const dark = inject('dark', false)

    const githubImage = computed(() => (dark.value ? githubWhite : githubBlack))
