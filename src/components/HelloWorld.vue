<template>
  <div class="about">
    ...
    <button :disabled="!state.indexes.length" @click="drillup" class="mb-5 px-6 py-2 rounded bg-emerald-400 hover:bg-emerald-500 text-emerald-100 disabled:bg-slate-300 disabled:text-slate-600">Go back</button>
